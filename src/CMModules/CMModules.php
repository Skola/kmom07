<?php
/**
* A model for managing Skola modules.
*
* @package SkolaCore
*/
...
* Properties
*/
  private $SkolaCoreModules = array('CSkola', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $SkolaCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
...
*/
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isSkolaCore'] = in_array($rc->name, $this->SkolaCoreModules);
      $details['isSkolaCMF'] = in_array($rc->name, $this->SkolaCMFModules);
