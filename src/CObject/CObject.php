<?php
/**
* Holding a instance of CSkola to enable use of $this in subclasses and provide some helpers.
*
* @package SkolaCore
*/
class CObject {
...
/**
* Wrapper for same method in CSkola. See there for documentation.
*/
